...
function formatNumberAxisSmart(value, dataRange) {
  ...
  // Add rest of your JavaScript here - the file was cut off in your message
  // Copy everything after this function from your original file
}

// NOTE: The script appears to be cut off. You'll need to copy the rest of the JavaScript
// from where it says "[...]" in your original file to complete this file.
